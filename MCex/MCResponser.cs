...
namespace MCex
{
    class MCResponser
    {
        ...
        /*リクエストパケット受信用メソッド*/
        //
        internal static void WaitRequest(string mc_address, string yc_address, int reqport)
        {
            //各変数の初期化
            flag = false;
            udpClient = null;
        ...
        private static void ReceiveCallback(IAsyncResult ar)
        {
            ...
            {
                //client.close()されたときに出るudp.EndReceiveの例外処理
                if (flag == true)
                {
                    return;
                }
            ...
            //受信したパケットが特定の値のときにManualResetEventをSetして本流の処理を流す
        ...
        /*response送信用メソッド*/
        //
        internal static void SendResponse(string mc_address, string yc_address, int resport)
        {
